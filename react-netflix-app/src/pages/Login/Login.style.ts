...
export const SubmitButton = tw(SmallButton)`
  w-full text-white bg-[#e50815] mt-6 mx-0 mb-3 rounded-md text-[16px]  h-[46px] flex items-center justify-center
`;
export const GoogleButton = tw.button`
  bg-white [color: rgb(0,0,0,0.54)] w-full h-[46px] font-medium flex items-center justify-center rounded-md
`;
